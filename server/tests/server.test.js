...
describe('POST /todos', () => {
	it('should create a new todo by user one', (done) => {
...
describe('GET /todos/:id', () => {
	it('should return todo doc created by user one', (done) => {
		request(app)
...
describe('DELETE /todos/:id', () => {
	it('should remove a todo created by user two', (done) => {
...
describe('PATCH /todos/:id', () => {
	it('should update the todo created by user one', (done) => {
		var hexId = todos[0]._id.toHexString();
...
describe('POST /users/login', () => {
	...
	it('should reject invalid login', (done) => {
		request(app)
			...
			.send({
				email: users[1].email,
				password: users[1].password + '123'	//Wrong password
			})
			.expect(400)
			.expect((res) => {
